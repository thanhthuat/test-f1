...
const CompanyProgramer:React.FC<ICompanyProgramerProps> = (props ) => {
  return (
    ...
    <p className='prefixprogamer-title__content'>Chosun Biz provides high-quality economic contents <br/>
It is positioning itself as a premium economic medium.</p>
        </div>
         <div className='prefixprogamer-bg'>
